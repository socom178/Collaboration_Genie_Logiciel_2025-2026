...
<div class="main-content">
    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-header"><h3><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-shield-lock" viewBox="0 0 16 16">
                    ...
                    </svg> Changer le mot de passe</h3></div>
            <div class="card-body">
